...
export default function FinalCTA() {
  return (
    <section className="relative py-24 md:py-32 bg-gradient-to-br from-primary-200 via-accent-100 to-warm-200 overflow-hidden">
      {/* Rich texture */}
      ...
      <div className="container mx-auto px-6 md:px-8 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-semibold text-dark-900 mb-6 leading-tight">
            Ready to Simplify Your Operations?
          </h2>
          <p className="text-xl text-dark-700 mb-10 leading-relaxed font-light">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <a
              href="/contact"
              className="inline-flex items-center text-lg text-dark-900 border-b-2 border-dark-900 pb-1 hover:opacity-70 transition-opacity font-medium"
            >
              Get started
          ...
          <p className="text-dark-600 text-sm mt-10">
